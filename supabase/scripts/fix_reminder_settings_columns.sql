-- Execute no SQL Editor do Supabase se o salvamento de lembretes falhar
-- Arquivo completo: supabase/migrations/20250525000000_add_reminder_settings_columns.sql
